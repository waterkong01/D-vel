![header](https://capsule-render.vercel.app/api?type=waving&color=5c666a&height=200&section=header&text=D'vel&fontSize=70)
...
## **📃 작품 소개**
> 개발자를 위한 커뮤니티로, 소셜미디어 기반의 향상된 시스템입니다. 회원가입 및 로그인, 1:1 채팅, 게시글(피드), 머신러닝과 엘라스틱서치를 이용한 뉴스/트렌드 기능, 마이페이지 등의 기능을 구현하였습니다.
...
>
> **마이 페이지 (공동작업 - 유진기)**</br>
> 자기소개란 작성, 보유 기술 추가/삭제, 학력 및 경력 추가/삭제, 작성 게시물 수정/삭제
>
> **채팅 페이지**</br>
> 다른 사용자와 1:1 실시간 채팅
